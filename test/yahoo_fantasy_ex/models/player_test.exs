defmodule YahooFantasyEx.Models.PlayerTest do
  ...
  doctest YahooFantasyEx.Models.Player
      ...
      assert [
               %Player{
                 ...
                 player_advanced_stats: [
                   %Stat{stat_id: 1001, value: 0.0},
                   %Stat{stat_id: 1002, value: 0.0},
                   %Stat{stat_id: 1003, value: 0.0},
                   %Stat{stat_id: 1004, value: 0.0},
                   %Stat{stat_id: 1005, value: 0.0},
                   %Stat{stat_id: 1006, value: 0.0},
                   %Stat{stat_id: 1007, value: 0.0},
                   %Stat{stat_id: 1008, value: 0.0},
                   %Stat{stat_id: 1009, value: 0.0},
                   %Stat{stat_id: 1010, value: 0.0},
                   %Stat{stat_id: 1011, value: 0.0}
                 ],
                 player_id: 1600,
                 player_key: "419.p.1600",
                 player_points: 0.0,
                 player_stats: [
                   %Stat{stat_id: 1, value: nil},
                   %Stat{stat_id: 2, value: nil},
                   %Stat{stat_id: 8, value: nil},
                   %Stat{stat_id: 11, value: nil},
                   %Stat{stat_id: 14, value: nil},
                   %Stat{stat_id: 31, value: nil},
                   %Stat{stat_id: 32, value: nil}
                 ],
